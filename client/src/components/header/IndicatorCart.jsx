...
function IndicatorCart(props) {
        ...
        dropdown = (
            <div className="dropcart">
                ...
                <div className="dropcart__buttons">
                    <Link className="btn btn-secondary" to="/tienda/carrito">Ver Carrito</Link>
                    <Link className="btn btn-primary" to="/tienda/checkout">Pagar</Link>
                </div>
            </div>
        );
    } else {
    ...
    return (
        <Indicator url="/tienda/carrito" dropdown={dropdown} value={cart.quantity} icon={<Cart20Svg />} />
    );
}
