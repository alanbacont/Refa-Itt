...
class ProductTabs extends Component {
    ...
    render() {
        ...
        const tabs = [
            { key: 'description', title: 'Descripción', content: <ProductTabDescription /> },
            { key: 'specification', title: 'Especificaciones', content: <ProductTabSpecification /> },
            { key: 'reviews', title: 'Reseñas', content: <ProductTabReviews /> },
        ];
