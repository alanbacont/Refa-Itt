...
class ShopPageCart extends Component {
    ...
    renderTotals() {
        ...
        const extraLines = cart.extraLines.map((extraLine, index) => {
            ...
            if (extraLine.type === 'shipping') {
                calcShippingLink = <div className="cart__calc-shipping"><Link to="/">Calcular Envío</Link></div>;
            }
                ...
                <div className="container">
                    ...
                    <div className="cart__actions">
                        <form className="cart__coupon-form">
                            <label htmlFor="input-coupon-code" className="sr-only">Contraseña</label>
                            <input type="text" className="form-control" id="input-coupon-code" placeholder="Cupón" />
                            <button type="submit" className="btn btn-primary">Aplicar Cupón</button>
                        </form>
                        <div className="cart__buttons">
                            <Link to="/" className="btn btn-light">Continuar Comprando</Link>
                            {updateCartButton}
                        </div>
                    </div>
                        ...
                        <div className="col-12 col-md-7 col-lg-6 col-xl-5">
                            <div className="card">
                                <div className="card-body">
                                    <h3 className="card-title">Total del Carrito</h3>
                                    ...
                                    <Link to="/tienda/checkout" className="btn btn-primary btn-xl btn-block cart__checkout-button">
                                        Proceder al pago
                                    </Link>
                                </div>
                            </div>
    ...
    render() {
                ...
                <div className="block block-empty">
                    <div className="container">
                        <div className="block-empty__body">
                            <div className="block-empty__message">Tu carrito de compras está vacío!</div>
        ...
        return (
            <React.Fragment>
                <Helmet>
                    <title>{`Carrito — ${theme.name}`}</title>
                </Helmet>
