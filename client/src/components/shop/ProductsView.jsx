    ...
    if (productsListItems.length > 0) {
        ...
        content = (
            <div className="products-view__empty">
                <div className="products-view__empty-title">No hay productos que coincidan con los resultados</div>
                <div className="products-view__empty-subtitle">Intenta cambiando los filtros</div>
                <button
                    type="button"
