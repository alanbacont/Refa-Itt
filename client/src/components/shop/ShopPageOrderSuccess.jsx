            ...
            <div className="container">
                <div className="order-success__body">
                    <div className="order-success__header">
                        ...
                        <h1 className="order-success__title">Gracias</h1>
                        <div className="order-success__subtitle">Tu orden ha sido recibida</div>
                        <div className="order-success__actions">
                            <Link to="/" className="btn btn-xs btn-secondary">Ir a Inicio</Link>
                        </div>
                    </div>
                    ...
                    <div className="order-success__meta">
                        <ul className="order-success__meta-list">
                            <li className="order-success__meta-item">
                                <span className="order-success__meta-title">Número de orden:</span>
                                <span className="order-success__meta-value">{`#${order.id}`}</span>
                            </li>
                            <li className="order-success__meta-item">
                                <span className="order-success__meta-title">Creada el:</span>
                            ...
                            <li className="order-success__meta-item">
                                <span className="order-success__meta-title">Método de Pago:</span>
                            ...
                            <table>
                                <thead className="order-list__header">
                                    <tr>
                                        ...
                                        <th className="order-list__column-quantity">Ctdad</th>
                        ...
                        <div className="col-sm-6 col-12 px-2">
                            <div className="card address-card">
                                <div className="address-card__body">
                                    ...
                                    <div className="address-card__row">
                                        <div className="address-card__row-title">Dirección Email</div>
