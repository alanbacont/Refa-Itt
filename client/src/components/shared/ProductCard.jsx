...
function ProductCard(props) {
    ...
    if (product.badges.includes('descuento')) {
        badges.push(<div key="descuento" className="product-card__badge product-card__badge--sale">Descuento</div>);
    }
    if (product.badges.includes('popular')) {
        badges.push(<div key="popular" className="product-card__badge product-card__badge--hot">Popular</div>);
    }
    if (product.badges.includes('nuevo')) {
        badges.push(<div key="nuevo" className="product-card__badge product-card__badge--new">Nuevo</div>);
    }
        ...
        <div className={containerClasses}>
            ...
            <div className="product-card__info">
                ...
                <div className="product-card__rating">
                    ...
                    <div className=" product-card__rating-legend">{`${product.reviews} Reseñas`}</div>
                </div>
                {features}
            </div>
