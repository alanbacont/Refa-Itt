...
class BlockSlideShow extends Component {
    ...
    slides = [
        {
            title: '¡Llantas en oferta!',
            text: 'Aprovecha las mejores ofertas en Refaccionaria Ruiz.',
            image_classic: {
                ltr: 'images/slides/banner-llantas.png',
        ...
        {
            title: 'Los mejores <br> aceites',
            text: 'La mejor variedad y calidad en productos <br>la encuentras aquí.',
            image_classic: {
                ltr: 'images/slides/banner-aceite.png',
        ...
        {
            title: 'Herramientas <br> para tu taller',
            text: 'Consigue las mejores herramientas para cubrir <br>tus necesidades.',
            image_classic: {
                ltr: 'images/slides/banner-herramienta.png',
                ...
                <div key={index} className="block-slideshow__slide">
                    ...
                    <div className="block-slideshow__slide-content">
                        ...
                        <div className="block-slideshow__slide-button">
                            <Link to="/" className="btn btn-primary btn-lg btn-slide">Comprar Ahora</Link>
                        </div>
                    </div>
                </div>
            );
